...
<div class="container-fluid px-4">
    <h2 class="mt-4">Nueva Entrada de Stock</h2>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('stock-entries.index') }}">Entradas</a></li>
        <li class="breadcrumb-item active">Nuevo Borrador</li>
    </ol>
    ...
    <div class="card mb-4 shadow-sm border-0">
        <div class="card-body">
            ...
            <form action="{{ route('stock-entries.store') }}" method="POST" id="entryForm">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="date" name="entry_date" class="form-control" value="{{ old('entry_date', date('Y-m-d')) }}" required max="{{ date('Y-m-d') }}">
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="reference" class="form-control" value="{{ old('reference') }}" maxlength="200">
                    </div>
                </div>
                <div class="mb-4">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function addRow() {
            ...
            tr.querySelector('.product-select').addEventListener('change', updateGrandTotal);
            tr.querySelector('.qty-input').addEventListener('input', updateGrandTotal);
            tr.querySelector('.cost-input').addEventListener('input', updateGrandTotal);
