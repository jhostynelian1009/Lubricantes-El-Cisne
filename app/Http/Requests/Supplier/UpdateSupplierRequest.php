...
class UpdateSupplierRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $supplier && ($this->user()?->can('update', $supplier) ?? false);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'identification' => ['nullable', 'string', 'max:20', Rule::unique('suppliers', 'identification')->ignore($supplierId)],
    ...
    public function messages(): array
    {
        return [
            ...
            'name.max' => 'El nombre del proveedor no debe exceder los 160 caracteres.',
            'identification.max' => 'La identificación no debe exceder los 20 caracteres.',
            'identification.unique' => 'Ya existe un proveedor registrado con esta identificación.',
